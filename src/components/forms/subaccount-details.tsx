  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      toast({
        ...
        description:
          "Les détails du sous-compte ont été enregistrés avec succès.",
      });
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Veuillez entrer les détails de votre entreprise
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Logo du sous-compte</FormLabel>
                  <FormControl>
                    <FileUpload
            ...
            <div className="flex md:flex-row gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    <FormLabel>Nom du sous-compte</FormLabel>
                    <FormControl>
                      <Input
                        required
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    <FormLabel>Email du sous-compte</FormLabel>
                    <FormControl>
            ...
            <div className="flex md:flex-row gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    <FormLabel>Numéro de téléphone du sous-compte</FormLabel>
                    <FormControl>
                      <Input placeholder="Téléphone" required {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
