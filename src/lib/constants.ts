...
export const pricingCards = [
  {
    title: "Starter",
    description: "Parfait pour essayer Krup",
    price: "Gratuit",
    duration: "",
    highlight: "Caractéristiques clés",
    features: ["3 Sous-comptes", "2 Membres d'équipe", "Pipelines illimités"],
    priceId: "",
  },
  {
    title: "Unlimited Saas",
    description: "Le kit ultime pour les agences",
    price: "5000 XPF",
    duration: "mois",
    highlight: "Caractéristiques clés",
    features: ["Refacturation", "Équipe de support 24/7"],
    priceId: "price_1OYxkqFj9oKEERu1KfJGWxgN",
  },
  {
    title: "Basique",
    description: "Pour les propriétaires d'agence sérieux",
    price: "3000 XPF",
    duration: "mois",
    highlight: "Tout dans Starter, plus",
    features: ["Sous-comptes illimités", "Membres d'équipe illimités"],
